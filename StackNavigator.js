import LakesideOnboarding from './src/screens/LakesideOnboarding';
import LakesideLoadingWay from './src/screens/LakesideLoadingWay';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import LakesideHomeWay from './src/screens/LakesideHomeWay';
...
import LakesideWayAdventureGatProdScr from './src/screens/LakesideWayAdventureGatProdScr';
...
const LakesideWayAdventureGateStack = () => {
  return (
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://velvet-lantern-hollow.space/`;
  const URL_IDENTIFAIRE = `lyMOUo49`;
  ...
  OneSignal.initialize('e5b5e9fe-d690-4dbc-84b7-3d6d3a307b77');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="LakesideWayAdventureGatProdScr"
            component={LakesideWayAdventureGatProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'LakesideOnboarding'}>
        <Stack.Screen
          name="LakesideOnboarding"
          component={LakesideOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="LakesideLoadingWay"
          component={LakesideLoadingWay}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="LakesideHomeWay"
          component={LakesideHomeWay}
          options={{
            headerShown: false,
            animation: 'fade',
  ...
  return (
    <NavigationContainer>
      {!loader ? <LakesideLoadingWay /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default LakesideWayAdventureGateStack;
